...
import {
  ...
  MessageCircle, Plus, ArrowLeft, Video, Smile, Paperclip, Mic
} from "lucide-react"
          ...
          {updatedSelected.messages.map((m) => (
            <div key={m.id} className={`flex ${m.isSent ? "justify-end" : "justify-start"}`}>
              <div className={`max-w-[80%] px-3 py-2 rounded-lg ${
                m.isSent ? "bg-green-700 text-white" : "bg-gray-700 text-white"
              }`}>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex-1 relative">
              <Input
                ...
                placeholder="Mensaje"
                className="bg-gray-800 border-gray-700 text-white rounded-full pr-20"
              />
            ...
            <Button
              ...
              className="bg-green-500 hover:bg-green-600 w-12 h-12 rounded-full p-0"
            >
              <Mic size={24} />
            </Button>
          </div>
  ...
  return (
    <div className="bg-gray-900 text-white h-screen w-screen flex flex-col">
      ...
      <div className="fixed bottom-16 right-4 md:bottom-20">
        <Button
          className="bg-green-500 hover:bg-green-600 w-14 h-14 rounded-full shadow-lg"
          onClick={() => {
